...
$comments_latest    = getLatest('id, comment, add_date, projectname, username', 'comments_view', 'add_date', 6);
?>
...
<div class="container text-center home-stats">
    ...
    <div class="row pt-4">
        ...
        <div class="col-sm-12 mt-4">
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-clipboard"></i> Recently Added Comments
                    <span class="toggle-info pull-right">
                        <i class="fa fa-arrow-up"></i>
                    </span>
                </div>
                <div class="card-body">
                    <ul class="list-unstyled latest">
                        <?php foreach ($comments_latest as $comment) { ?>
                            <li>
                                <div class="row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-2">
                                        <?php echo $comment['projectname'] ?>
                                    </div>
                                    <div class="col-sm-2">
                                        <?php echo $comment['username'] ?>
                                    </div>
                                    <div class="col-sm-2">
                                        <a href="deleteComment.php?id=<?php echo $comment['id']; ?>" class="btn btn-sm btn-danger confirm-delete" role="button" method="POST">
                                            <i class="fa fa-close"></i> Delete
                                        </a>
                                    </div>
                                </div>
